...
So I built this tool as a way to make the process more accessible. It's a reproducible workflow that uses Claude to search EdReports and Evidence for ESSA, synthesize the findings, and generate a report with critical questions to ask vendors—all in a few minutes instead of several hours.
